...
(function( $ ) {
	...
	$( document ).ready( function() {
		...
		// submission
		$( document ).on( 'submit', '.mmcs-email-form', function( e ) {
			...
			$.ajax( {
				...
				beforeSend: function() {
					$( '.mmcs-email-form' ).block( {
						message: '<center><div style="background: transparent; font-size: 13px; font-weight: 700; padding: 6px; color: #ffffff;">Processing..</div></center>',
						css: {
							border: 'none',
